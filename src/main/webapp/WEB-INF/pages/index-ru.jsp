        ...
        <div class="top-header">
            ...
            <div class="top-nav">
                <div class="navigation">
                    ...
                    <div class="logo">
                        <h1><a href="/ru"><span>S</span>Success-Site</a></h1>
                    </div>
        ...
        <div id="owl-demo1" class="owl-carousel owl-carousel2">
            ...
            <div class="item">
                <div class="about-left-grid">
                    ...
                    <p>Ваш сайт обеспечит приток огромного количества клиентов со всего мира.</p>
                    <ul>
                        <li><a class="a-btn-a scroll" href="#" data-toggle="modal" data-target="#myModal1">Заказать</a></li>
                        <li><a class="a-btn-h scroll" href="#contact">Спросить</a></li>
                    </ul>
            ...
            <div class="col-md-6 wthree_about_right_grid">
                ...
                <div class="col-xs-8 wthree_about_right_grid_right">
                    ...
                    <p>Каждому блогеру свой сайт.<br><br>
                        ...
                        Такой сайт должен состоять из двух частей: пользовательской и блогерной.<br><br>
                        Пользовательская часть позволяет посетителю насладится полнотой контента представленного в вашем
                        блоге, а блогерная часть предназначена для добавления, редактирования или удаления материалов.</p>
                </div>
                <div class="clearfix"></div>
            </div>
            <div class="col-md-6 wthree_about_right_grid">
            ...
            <div class="col-md-6 wthree_about_right_grid">
                ...
                <div class="col-xs-8 wthree_about_right_grid_right">
                    ...
                    <p>Сайт, предназначенный для представления в интернете информации о предприятиях и корпорациях.<br><br>
                        Корпоративный сайт может содержать множество разделов, предназначенных для работы с клиентом, найма
